...
public class DatabaseUtil {
    ...
    public final static String dbName = "Testing";           // Whatever Schema you created in tutorial.
    ...
    protected static Connection connect() throws Exception {
        ...
        dbUsername ="admin";//System.getenv("dbUsername");
        if (dbUsername == null) {
            System.err.println("Environment variable dbUsername is not set!");
        }
        dbPassword = "proteusams";//System.getenv("dbPassword");
        if (dbPassword == null) {
            System.err.println("Environment variable dbPassword is not set!");
        }
        rdsMySqlDatabaseUrl = "proteusdbams.c09zdqyfxeug.us-east-2.rds.amazonaws.com";//System.getenv("rdsMySqlDatabaseUrl");
